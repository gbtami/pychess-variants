...
export function pgettext(msgctxt: string, msgid: string, ...vars: any) {
    return i18n.pgettext(msgctxt, msgid, vars);
}
...
export const translatedColorNames = [_('White'), _('Black'), _('Red'), _('Blue'), _('Gold'), _('Pink'), _('Green')];
