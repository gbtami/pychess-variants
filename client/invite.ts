    ...
    if (model['inviter'] === 'expired') {
        return [
            h('div.invite', [
                ...
                h('div.inviteinfo', [h('div', _('It may have been accepted, canceled, or expired.'))]),
                ...
                ? seekEmpty
                    ? h('div.inviteinfo', [
                          ...
                          h('div', [
                              ...
                              h('input#invite-url-player1', {
                                  attrs: { readonly: true, spellcheck: false, value: model['home'] + gameURLPlayer1 },
                              }),
                              h(
                                  'button#paste-url-player1',
                                  {
                                      class: { 'paste-url': true },
                                      on: {
                                          click: () => {
                                              copyTextToClipboard(model['home'] + gameURLPlayer1);
                                              patch(
                                                  document.getElementById('paste-icon-player1') as HTMLElement,
                                                  h('i#paste-icon-player1', {
                                                      props: { title: _('Copy URL') },
                                                      class: { icon: true, 'icon-check': true },
                                                  }),
                                              );
                                          },
                                      },
                          ...
                          h('div', [
                              ...
                              h('input#invite-url-player2', {
                                  attrs: { readonly: true, spellcheck: false, value: model['home'] + gameURLPlayer2 },
                              }),
                              h(
                                  'button#paste-url-player2',
                                  {
                                      class: { 'paste-url': true },
                                      on: {
                                          click: () => {
                                              ...
                                              patch(
                                                  document.getElementById('paste-icon-player2') as HTMLElement,
                                                  h('i#paste-icon-player2', {
                                                      props: { title: _('Copy URL') },
                                                      class: { icon: true, 'icon-check': true },
                                                  }),
                                              );
                    ...
                    : h('div.inviteinfo', [
                          h('div', _('To invite someone to play, give them this URL:')),
                          h('input#invite-url', {
                              attrs: { readonly: true, spellcheck: false, value: model['home'] + gameURL },
                          }),
                          h(
                              'button#paste-url',
                              {
                                  ...
                                  on: {
                                      click: () => {
                                          ...
                                          patch(
                                              document.getElementById('paste-icon') as HTMLElement,
                                              h('i#paste-icon', {
                                                  props: { title: _('Copy URL') },
                                                  class: { icon: true, 'icon-check': true },
                                              }),
