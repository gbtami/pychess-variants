...
export const VARIANTS = {
    makruk: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["makruk.svg", "makruk.jpg"], pieces: "makruk", PieceCSS: ["makrukwb", "makrukwr", "makruk", "makruks"], icon: "Q"},
    cambodian: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["makruk.svg", "makruk.jpg"], pieces: "makruk", PieceCSS: ["makrukwb", "makrukwr", "makruk", "makruks"], icon: "!"},
    ...
    grandhouse: { geom: Geometry.dim10x10, cg: "cg-640-640", BoardCSS: ["10x10brown.svg", "10x10blue.svg", "10x10green.svg", "10x10maple.jpg", "10x10olive.jpg"], pieces: "capa", PieceCSS: ["capa0", "capa1", "capa2", "capa3"], icon: "*", baseURL: ["capa", "seir", "green", "musk"] },
