...
export const VARIANTS = {
    ...
    sittuyin: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["sittuyin.svg", "sittuyin.jpg"], pieces: "sittuyin", PieceCSS: ["sittuyins", "sittuyinm"], icon: "R", baseURL: ["makruk", "sittuyin"] },
    ...
    shogun: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["ShogunPlain.svg", "ShogunMaple.png", "ShogunMaple2.png", "ShogunBlue.svg"], pieces: "shogun", PieceCSS: ["shogun0", "shogun1", "shogun2"], icon: "-" , baseURL: ["shogun", "shogun1", "shogun2"] },
}
