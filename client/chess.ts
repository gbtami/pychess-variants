...
export const VARIANTS = {
    ...
    sittuyin: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["sittuyin.svg", "sittuyin.jpg", "sittuyingreen.svg"], pieces: "sittuyin", PieceCSS: ["sittuyins", "sittuyinm", "sittuyini"], icon: ":", baseURL: ["sittuyin", "makruk", "makruk3"] },
    ...
    xiangqi: { geom: Geometry.dim9x10, cg: "cg-576-640", BoardCSS: ["xiangqi.svg", "xiangqic.svg", "xiangqiCTexture.png", "xiangqiPaper.png", "xiangqiWood.png", "xiangqiDark.svg"], pieces: "xiangqi", PieceCSS: ["xiangqi", "xiangqie", "xiangqict2", "xiangqihnz", "xiangqict2w", "xiangqihnzw"], icon: "8" },
    ...
    shogun: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["ShogunPlain.svg", "ShogunMaple.png", "ShogunMaple2.png", "ShogunBlue.svg", "8x8brown.svg", "8x8maple.jpg"], pieces: "shogun", PieceCSS: ["shogun0", "shogun1", "shogun2"], icon: "-" , baseURL: ["shogun", "shogun1", "shogun2"] },
}
