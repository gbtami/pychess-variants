...
export const VARIANTS = {
    ...
    sittuyin: { geom: Geometry.dim8x8, cg: "cg-512", BoardCSS: ["sittuyin.svg", "sittuyin.jpg", "sittuyingreen.svg", "sittuyinGrainBrown.svg"], pieces: "sittuyin", PieceCSS: ["sittuyins", "sittuyinkagr", "sittuyinkabr", "sittuyinm", "sittuyini"], icon: ":", baseURL: ["sittuyin/Ka_blackred", "sittuyin/Ka_greenred", "sittuyin/original", "makruk/ada", "makruk/intl"] },
    ...
    janggi: { geom: Geometry.dim9x10, cg: "cg-576-640", BoardCSS: ["Janggi.svg", "JanggiPaper.png", "JanggiWood.png", "JanggiDark.svg"], pieces: "janggi", PieceCSS: ["janggihb", "janggihg", "janggiib", "janggiig"], icon: "=" },
