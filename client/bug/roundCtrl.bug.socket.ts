...
export class RoundControllerBughouseSocket {
    ...
    constructor(ctrl: RoundControllerBughouse) {
        ...
        const onOpen = () => {
            ...
            } catch (e) {//TODO:NIKI:now we return false instead of exception
        ...
        this.sock = createWebsocket('wsr/' + ctrl.gameId, onOpen, onReconnect, onClose, (e: MessageEvent) => this.onMessage(e));
    }
