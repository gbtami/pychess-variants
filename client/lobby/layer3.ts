...
export function layer3variant (container2Id: string, lobbyCtrl: LobbyController, variantName: string, chess960: boolean): void {
    ...
    const layer3cont = h(`div#${container3Id}.layer-3-container.chess-l3` , [
        h('button.layer-2-category l3v', [
            ...
            h('ul.l3links-cont', [
                h('li.l3links', { class: {"icon": true, "icon-crossedswords": true}, on: { click: () => lobbyCtrl.createGame(variantName, chess960) } }, _('Random Opponent')),
                ...
                h('li.l3links', { class: {"icon": true, "icon-bot": true}, on: { click: () => lobbyCtrl.playAI(variantName, chess960) } }, _('Play Vs. Computer')),
