        ...
        infoItems.push(
            h(
                'h5#chessl2back',
                {
                    ...
                    on: { click: () => goBackToLayer1(lobbyCtrl, 'layer2chesscont') },
                },
                _('Go Back'),
            ),
        );
    ...
    const layer2cont = h('div#layer2chesscont.layer-2-container.fairy-grid', [
        ...
        h('div.button-grid', [
            h(
                ...
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'chess') } },
                [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'crazyhouse') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'atomic') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'kingofthehill') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, '3check') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'antichess') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'racingkings') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'horde') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'placement') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'alice') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2chesscont', lobbyCtrl, 'fogofwar') } },
                [
                    h('div.variant-title-l2', [
