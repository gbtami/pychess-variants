...
export function layer2makruk (lobbyCtrl: LobbyController, containerId: string): void {
    ...
    const layer2cont = h('div#layer2makrukcont.layer-2-container.fairy-grid', [
        ...
        h('div.button-grid', [
            h('button.layer-2-category', { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'makruk', false) } }, [
            ...
            h('button.layer-2-category', { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'makpong', false) } }, [
                h('div.variant-title-l2', [
            ...
            h('button.layer-2-category', { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'cambodian', false) } }, [
                h('div.variant-title-l2', [
            ...
            h('button.layer-2-category', { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'sittuyin', false) } }, [
                h('div.variant-title-l2', [
            ...
            h('button.layer-2-category', { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'asean', false) } }, [
                h('div.variant-title-l2', [
