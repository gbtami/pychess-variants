...
export function layer2makruk(lobbyCtrl: LobbyController, containerId: string, showBack: boolean = true): void {
    const variant = VARIANTS['makruk'];
    const infoItems = [
        h('h4', _('Makruk Variants')),
        variantBoard(variant, variant.startFen),
        h(
            'p.variant-category-description.makruk-desc',
            _('Southeast Asian variants, closely related to Western Chess.'),
        ),
    ];
        ...
        infoItems.push(
            h(
                'h5#makrukl2back',
                {
                    ...
                    on: { click: () => goBackToLayer1(lobbyCtrl, 'layer2makrukcont') },
                },
                _('Go Back'),
            ),
        );
    ...
    const layer2cont = h('div#layer2makrukcont.layer-2-container.fairy-grid', [
        ...
        h('div.button-grid', [
            h(
                ...
                { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'makruk') } },
                [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'makpong') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'cambodian') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'sittuyin') } },
                [
                    h('div.variant-title-l2', [
            ...
            h(
                'button.layer-2-category',
                { on: { click: () => layer3variant('layer2makrukcont', lobbyCtrl, 'asean') } },
                [
                    h('div.variant-title-l2', [
