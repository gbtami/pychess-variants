...
export const BOARD_FAMILIES: Record<string, BoardFamily> = {
    ...
    shogi9x9: { dimensions: { width: 9, height: 9 }, cg: "cg-576", boardCSS: ["shogi.svg", "Shogiban1.png", "Shogiban2.png", "shogic.svg", "ShogiMaple.png", 'ShogiGrayTexture.png', "ShogiSpace1.svg", "dobutsu.png", "ShogiOak.png", "CreepyOak.png"] },
...
export const PIECE_FAMILIES: Record<string, PieceFamily> = {
    ...
    shogi: { pieceCSS: ["shogik", "shogi", "shogiw", "shogip", "shogim", "shogip3d", "shogikw3d", "shogid", "shogiim", "shogio", "shogibw", "shogictbnw", "portk", "porti", "cz", "firi", "disguised"] },
...
function variantPieceLetters(variant: Variant): Set<cg.Letter> {
    ...
    addPieceLetters(letters, variant.pieceRow.white.map(role => util.letterOf(role)));
    addPieceLetters(letters, variant.pieceRow.black.map(role => util.letterOf(role)));
    addPieceLetters(letters, variant.kingRoles.map(role => util.letterOf(role)));
    addPieceLetters(letters, variant.pocket?.roles.white.map(role => util.letterOf(role)));
    addPieceLetters(letters, variant.pocket?.roles.black.map(role => util.letterOf(role)));
