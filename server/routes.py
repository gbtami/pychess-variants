...
from catalogued_variants import (
    ...
    delete_catalogued_board,
    delete_catalogued_piece_set,
    delete_catalogued_variant,
    get_catalogued_board_css,
    get_catalogued_disguised_piece_css,
    get_catalogued_piece_css,
...
get_routes: tuple[RouteDef, ...] = (
    ...
    ("/friendly-sites", friendly_sites.friendly_sites),
    ("/games", games.games),
    ("/games/search", game_search.game_search),
    ...
    (r"/bot-challenge/{gameId:\w{8}}", bot_challenge_view.bot_challenge),
    ("/notified", notified),
    ...
    ("/api/catalogued-variants/{name}/piece-css.css", get_catalogued_piece_css),
    ("/api/catalogued-variants/{name}/piece-disguised.css", get_catalogued_disguised_piece_css),
    ("/api/catalogued-variants/{name}/board-css.css", get_catalogued_board_css),
    ("/api/games", get_games),
...
post_routes: tuple[RouteDef, ...] = (
    ...
    ("/account/bot/token/create", account_bot_token_create),
    (r"/account/bot/token/{tokenId:\w{8}}/revoke", account_bot_token_revoke),
    ("/account/bot/upgrade", account_bot_upgrade_post),
    ...
    ("/api/bot/account/upgrade", upgrade_account),
    ...
    (r"/bot-challenge/cancel/{gameId:\w{8}}", bot_challenge_view.cancel_bot_challenge),
    ...
    ("/api/catalogued-variants/{name}/piece-set/delete", delete_catalogued_piece_set),
    ("/api/catalogued-variants/{name}/board", upload_catalogued_board),
    ("/api/catalogued-variants/{name}/board/delete", delete_catalogued_board),
    ("/api/catalogued-variants/{name}/favorite", set_catalogued_variant_favorite),
    ...
    (r"/tournaments/{tournamentId:\w{8}}/delete", tournaments.tournaments),
