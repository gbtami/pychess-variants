...
VIDEOS = {
    ...
    "WmMw97hp8C0": ("Makpong, Ouk Chatrang (Cambodian Chess), and ASEAN Chess - How to play", "5:26"),
    ...
    "KDkF2dEt41g": ("Janggi (Korean Chess) - How to play (using internationalized piece set)", "17:13"),
    ...
    "5EDG5RP8OZ8": ("Xiangqi (Chinese Chess) - How to play (Using Internationalized Piece Set)", "8:13"),
    ...
    "-DHY3xhB0aE": ("European Grandmaster Joep Nabuurs' #1 Tip for Chess Players Trying to Improve at Xiangqi", "12:47"),
