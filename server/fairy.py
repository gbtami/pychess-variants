...
FILES: list = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"]

STANDARD_FEN: list = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
...
class FairyBoard:
    def __init__(self, variant, initial_fen="", chess960=False, count_started=0):
        ...
        self.initial_fen = (
            initial_fen if initial_fen else self.start_fen(variant, chess960)
        )
        self.move_stack = []
        self.ply = 0
    ...
    def get_san(self, move):
        return sf.get_san(
            ...
            move,
            self.chess960,
            sf.NOTATION_JANGGI if self.variant == "janggi" else sf.NOTATION_DEFAULT,
        )
...
if __name__ == "__main__":
    ...
    FEN: str = "rnb+fkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNB+FKBNR w KQkq - 0 1"
