...
export const VARIANTS = {
    makruk: { geom: Geometry.dim8x8, cg: "cg-512", board: "grid", pieces: "makruk", css: "makruk"},
    sittuyin: { geom: Geometry.dim8x8, cg: "cg-512", board: "gridx", pieces: "makruk", css: "sittuyin" },
    shogi: { geom: Geometry.dim9x9, cg: "cg-576", board: "grid9x9", pieces: "shogi", css: "shogi0" },
    xiangqi: { geom: Geometry.dim9x10, cg: "cg-576-640", board: "river", pieces: "xiangqi", css: "xiangqi" },
    placement: { geom: Geometry.dim8x8, cg: "cg-512", board: "brown", pieces: "merida", css: "standard" },
    crazyhouse: { geom: Geometry.dim8x8, cg: "cg-512", board: "brown", pieces: "merida", css: "standard" },
    capablanca: { geom: Geometry.dim10x8, cg: "cg-640", board: "capablanca", pieces: "merida", css: "capablanca" },
    seirawan: { geom: Geometry.dim8x8, cg: "cg-512", board: "brown", pieces: "merida", css: "seirawan" },
    standard: { geom: Geometry.dim8x8, cg: "cg-512", board: "brown", pieces: "merida", css: "standard" },
}
