...
export const VARIANTS = {
    ...
    capablanca: { geom: Geometry.dim10x8, cg: "cg-640", board: "capablanca", pieces: "capa", css: ["capa0", "capa1", "capa2"], icon: "P" },
    capahouse: { geom: Geometry.dim10x8, cg: "cg-640", board: "capablanca", pieces: "capa", css: ["capa0", "capa1", "capa2"], icon: "P" },
    grand: { geom: Geometry.dim10x10, cg: "cg-640-640", board: "grand", pieces: "capa", css: ["capa0", "capa1", "capa2"], icon: "G" },
    grandhouse: { geom: Geometry.dim10x10, cg: "cg-640-640", board: "grand", pieces: "capa", css: ["capa0", "capa1", "capa2"], icon: "G" },
