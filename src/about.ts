            ...
            h('main.main', [
                h('div.about', [
                    ...
                    h('p', [
                        ...
                        ", ",
                        h('a', {attrs: {href: 'https://en.wikipedia.org/wiki/Grand_Chess'}}, 'Grand chess'),
                        ", ",
                        ...
                        ", ",
                        h('a', {attrs: {href: 'https://en.wikipedia.org/wiki/Gothic_chess'}}, 'Gothhouse (Gothic+Crazyhouse)'),
                        ", ",
                        h('a', {attrs: {href: 'https://www.twitch.tv/videos/476859273'}}, 'Grandhouse (Grand+Crazyhouse)'),
                        " and standard ",
