...
class VariantAuthorsRegistryTestCase(unittest.TestCase):
    def test_public_authors_have_complete_attribution(self):
        ...
        self.assertGreaterEqual(len(public), 11)
...
class VariantAuthorsPageTestCase(AioHTTPTestCase):
    ...
    async def test_authors_page_lists_publishable_authors_and_variant_links(self):
        ...
        self.assertIn('href="/variants/capablanca"', text)
        self.assertIn('href="/variants/dobutsu"', text)
        ...
        self.assertIn('href="/variants/alice"', text)
        self.assertIn('href="/variants/racingkings"', text)
        self.assertIn('href="/variants/shako"', text)
        self.assertIn('href="/variants/kyotoshogi"', text)
        self.assertIn('href="/variants/torishogi"', text)
