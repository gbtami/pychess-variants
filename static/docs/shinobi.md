...
10.	**Repetition** - Similar to the above, repeating the same position results in a draw.
12.	The Clan cannot castle.
12.	Other rules, including Kingdom moves and en passant, are as in standard international chess.
