...
<details><summary>为什么我不能在大厅聊天中发送消息?</summary>

大厅聊天仅供活跃的 Pychess 玩家使用。要在其中发言，你的帐号必须注册满 24 小时、至少完成 10 盘棋，并且其中至少 5 盘是在标准国际象棋以外的变体中进行的积分棋。你仍然可以阅读大厅聊天；此限制不影响对局聊天或锦标赛聊天。</details>
