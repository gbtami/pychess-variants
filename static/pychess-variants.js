...
var RoundController = /** @class */ (function () {
    function RoundController(el, model, handler) {
        ...
        var opts = {
            ...
            onreconnect: function (e) { _this.clocks[0].connecting = true; _this.clocks[1].connecting = true; console.log('Reconnecting...', e); },
