...
class RoundController {
    constructor(el, model) {
        ...
        /*
            ...
            private castleRook = (kingOrig, kingDest, color, captures) => {
                const diff: PiecesDiff = {};
                if (captures) {
                    if (kingOrig > kingDest) {
        ...
        */
        ...
        this.onUserMove = (orig, dest, meta) => {
            ...
            /*
                    // chessground autoCastle works for standard chess only
                    if (this.variant === "capablanca" && moved.role === "king") {
                        console.log("ITT", orig, dest, meta.captured);
                        if (meta.captured && meta.captured.role === 'rook') {
                            this.castleRook(orig, dest, this.mycolor, true);
                        } else if (orig[0] === "f" && (dest[0] === 'c' || dest[0] === 'i')) {
                            this.castleRook(orig, dest, this.mycolor, false);
                        }
                    }
            */
