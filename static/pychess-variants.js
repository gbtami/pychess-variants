    ...
    function RoundController(el, model, handler) {
        ...
        this.checkStatus = function (msg) {
            ...
            if (msg.status >= 0) {
                ...
                if (_this.tv) {
                    setInterval(function () { _this.doSend({ type: "updateTV", gameId: _this.model["gameId"] }); }, 2000);
                }
            }
        };
        this.onMsgUpdateTV = function (msg) {
            if (msg.gameId !== _this.model["gameId"]) {
                window.location.assign(_this.model["home"] + '/tv');
            }
        };
