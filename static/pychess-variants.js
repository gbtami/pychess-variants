...
exports.VARIANTS = {
    ...
    placement: { geom: 0 /* dim8x8 */, cg: "cg-512", board: "brown", pieces: "standard", css: ["standard", "green", "alpha"], icon: "S" },
    crazyhouse: { geom: 0 /* dim8x8 */, cg: "cg-512", board: "brown", pieces: "standard", css: ["standard", "green", "alpha"], icon: "H" },
    capablanca: { geom: 2 /* dim10x8 */, cg: "cg-640", board: "capablanca", pieces: "capa", css: ["capa0", "capa1", "capa2", "capa3"], icon: "P" },
    capahouse: { geom: 2 /* dim10x8 */, cg: "cg-640", board: "capablanca", pieces: "capa", css: ["capa0", "capa1", "capa2", "capa3"], icon: "P" },
    grand: { geom: 4 /* dim10x10 */, cg: "cg-640-640", board: "grand", pieces: "capa", css: ["capa0", "capa1", "capa2", "capa3"], icon: "G" },
    grandhouse: { geom: 4 /* dim10x10 */, cg: "cg-640-640", board: "grand", pieces: "capa", css: ["capa0", "capa1", "capa2", "capa3"], icon: "G" },
    seirawan: { geom: 0 /* dim8x8 */, cg: "cg-512", board: "brown", pieces: "seirawan", css: ["seir1", "seir0", "seir2", "seir3"], icon: "L" },
    shouse: { geom: 0 /* dim8x8 */, cg: "cg-512", board: "brown", pieces: "seirawan", css: ["seir1", "seir0", "seir2", "seir3"], icon: "L" },
    standard: { geom: 0 /* dim8x8 */, cg: "cg-512", board: "brown", pieces: "standard", css: ["standard", "green", "alpha"], icon: "M" },
};
