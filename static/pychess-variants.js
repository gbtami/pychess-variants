...
var RoundController = /** @class */ (function () {
    function RoundController(el, model) {
        ...
        // render game data
        var container = document.getElementById('result');
        patch(container, h_1.h('result#result', this.variant));
        // flip
        // TODO: players, clocks
...
function updateMovelist(ctrl) {
    ...
    if (active)
        active.classList.remove('active');
    patch(container, h_1.default('ol.movelist#movelist', [h_1.default('li.move', { class: { active: true }, attrs: { ply: ply }, on: { click: function () { return selectMove(ctrl, ply); } } }, move)]));
    scrollToPly(ctrl);
}
