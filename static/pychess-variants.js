    ...
    function RoundController(el, model, handler) {
        ...
        var opts = {
            ...
            onreconnect: function (e) {
                ...
                clock_1.renderTime(_this.clocks[0], _this.clocks[0].duration);
                clock_1.renderTime(_this.clocks[1], _this.clocks[1].duration);
