...
class SeirawanBoard(bugchess.Board):
    ...
    def __init__(self, fen=starting_fen, chess960=False):
        self.hawks = bugchess.BB_EMPTY
        self.elephants = bugchess.BB_EMPTY
    ...
    def piece_type_at(self, square):
        ...
        mask = bugchess.BB_SQUARES[square]
...
def fen2png(fen, idx):
    ...
    print(board)
    board_svg = bugchess.svg.board(coordinates=False, board=board, size=350)
