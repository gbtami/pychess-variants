<h1 align="center">Seirawan Chess Endings 1</h1>
...
In the diagram, I've set up White's ideal winning position. The following checkmating pattern is rather cute and quite surprising: **1.Ed7+** (_1.Eb7+_ is equally good.) **1...Ka8 2.Ea7+ Kb8 3.Ea6!** Checkmate. It is this "retreating" move Ea7-a6 which is deceptive and easy to miss as such checkmating moves featuring a retreat are not common in orthodox chess.
...
This means that Black has to move his Rook along the back rank. Let us take a look at the various possibilities: **1...Rd8?**, walks into a simple fork: **2.Eb7+! Kc8 3.Ec7+** (_3.Ea7+_ is equally good) **3...Kb8 4.Ec6+**, forks King and Rook and is mate when the Rook is captured.

Equally simple are: **1...Re8? 2.Eb7+** (_3.Ed7+_ is equally good) **2...Kc8** (_2...Ka8 3.Ec7+_ forks King and Rook) **3.Ed6+**, forks King and Rook. While, **1...Rf8? 2.Ed7+**, forks King and Rook immediately.

Hence, White's only problem is how to meet: **1...Rg8!**, the only "safe square" for Black's Rook. Once more it is that deceptive "retreating" move which is the key to White's victory: **1.Ed7+** (_1.Eb7+_ is equally good) **1...Kc8 2.Ea7+ Kb8** (A forced return. Otherwise, _2...Kd8 3.Ea8+_ skewers the Rook.) **3.Ea6+!**, the winning move: **3...Kc8 4.Ea8+**, wins Black's Rook.
